...
function astoundify_contentimporter_get_default_strings() {
	return array(
		'type_labels' => array(
			'childtheme' => array( 'Child Theme', 'Child Theme' ),
			'setting' => array( __( 'Setting' ), __( 'Settings' ) ),
			'thememod' => array( __( 'Theme Customization' ), __( 'Theme Customizations' ) ),
		...
		'errors' => array(
			...
			'file_reading' => __( 'Unable to read content files. Please add <code>define( "FS_METHOD", "direct" );</code> to your <code>wp-config.php</code> file.' )
		)
	);
}
