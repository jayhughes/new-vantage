 ...
 * for theme mods relating to typography. 
 *
 * @since 1.0.0
 *
 ...
 * @return mixed
 */
function astoundify_themecustomizer_get_font_item( $theme_mod_key, $group = false, $group_id = 'font-pack' ) {
	$default = astoundify_themecustomizer_get_font_item_default( $theme_mod_key, $group, $group_id );

	return get_theme_mod( $theme_mod_key, $default );
}

/**
 * Get a font theme mod default.
 *
 * This is a wrapper for get_theme_mod() and should only be used
 * for theme mods relating to typography. 
 *
 ...
 * @return mixed
 */
function astoundify_themecustomizer_get_font_item_default( $theme_mod_key, $group = false, $group_id = 'font-pack' ) {
	$default = null;
